namespace Domains.AppMetaData
{
    public static class Router
    {
        ...
        public static class ProductRouting
        {
            ...
            public const string GetAllNew = Prefix + "GetAllNew";
        ...
        public static class CommentRouting
        {
            ...
            public const string GetAll = Prefix + "GetAll";
            public const string GetAllForUsers = Prefix + "GetAllForUsers";
            public const string GetById = Prefix + SingleRoute;
            public const string Create = Prefix + "Create";
            public const string Update = Prefix + "Update";
            public const string Delete = Prefix + SingleRoute;
        ...
        public static class OfferRouting
        {
            public const string Prefix = Rule + "Offer/";
            public const string GetAll = Prefix + "GetAll";
            public const string GetById = Prefix + SingleRoute;
            public const string Create = Prefix + "Create";
            public const string Update = Prefix + "Update";
        ...
        public static class OrdersRouting
        {
            ...
            public const string Update = Prefix + "Update";
            public const string Delete = Prefix + SingleRoute;
            public const string GetAllOrdersAsync = Prefix + "GetAllOrdersAsync";
