    ...
    public class RegisterServicesHelper
    {
        public static void RegisteredServices(WebApplicationBuilder builder )
        {
           ...
           .CreateLogger();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Eccomerce Project", Version = "v1" });
                c.EnableAnnotations();
                ...
                c.AddSecurityRequirement(new OpenApiSecurityRequirement
          {
            ...
            builder.Services.AddSingleton<IConnectionMultiplexer>(sp =>
            {
                ...
                config.ConnectTimeout = 10000;     // 🕐 يزيد مهلة الاتصال
                config.SyncTimeout = 10000;
                config.Password = "AWBGAAIncDJiNjVmNGUyOWRiOGE0ZDE0YjVmN2VhNDE4NWQxMDhhZHAyMjQ2NDY"; // 🟢 تأكد منها (نفس الباسورد في الرابط)
                config.EndPoints.Add("striking-fly-24646.upstash.io:6379");
            ...
            builder.Services.AddCors(options =>
            {
                ...
                {
                  builder.WithOrigins("http://localhost:4200", "https://localhost:4200", "https://adminpanel-abo-sdah.netlify.app", "https://abo-sdah.netlify.app")
          .AllowAnyHeader()
                .AllowAnyMethod()
                .AllowCredentials();
                });
